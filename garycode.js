...
const hoperoni = /^hope\b|\s?[^a-z]+\bhope[^a-z]?\b|^hope[^a-z]$|^hopeful\b|\s?[^a-z]+\bhopeful[^a-z]?\b|^hopeful[^a-z]$|^hopefully\b|\s?[^a-z]+\bhopefully[^a-z]?\b|^hopefully[^a-z]$|^hoped\b|\s?[^a-z]+\bhoped[^a-z]?\b|^hoped[^a-z]$|^hoping\b|\s?[^a-z]+\bhoping[^a-z]?\b|^hoping[^a-z]$|^hopefulness\b|\s?[^a-z]+\bhopefulness[^a-z]?\b|^hopefulness[^a-z]$|^hopefuls\b|\s?[^a-z]+\bhopefuls[^a-z]?\b|^hopefuls[^a-z]$|^hopeless\b|\s?[^a-z]+\bhopeless[^a-z]?\b|^hopeless[^a-z]$|^hopelessly\b|\s?[^a-z]+\bhopelessly[^a-z]?\b|^hopelessly[^a-z]$|^hopelessness\b|\s?[^a-z]+\bhopelessness[^a-z]?\b|^hopelessness[^a-z]$/i;
